  ...
  <v-app>
    ...
    <v-main class="app-main app-main--tinted">
      <div class="app-page-shell">
        <v-container v-if="route.path.startsWith('/admin')" class="pt-4 pb-0">
          <v-row>
            <v-col cols="12">
              <v-breadcrumbs :items="breadcrumbs" class="text-h5 text-sm-h4 font-weight-bold pa-0 breadcrumbs-wrap">
