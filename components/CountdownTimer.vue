...
const timeLeft = computed(() => {
  const target = new Date(props.startDate).getTime() + RESERVATION_DURATION;
...
<template>
  <slot :hours="formattedTime.hours" :minutes="formattedTime.minutes" :seconds="formattedTime.seconds"
